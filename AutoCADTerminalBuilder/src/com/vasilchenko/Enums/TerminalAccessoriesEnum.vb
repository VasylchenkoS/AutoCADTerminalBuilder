...
Namespace com.vasilchenko.Enums
    ...
    Public Enum TerminalAccessoriesEnum
        ...
        <Description("ATP-URTK/SP")> PC_PartitionPlateForURTK6
        ...
        <Description("D-URTK 6")> PC_EndCoverForURTK6
        <Description("UBE/D")> PC_TerminalMarker
        <Description("D-UK 4/10")> PC_EndCoverForUK_5_N
        <Description("D-UK 2,5")> PC_EndCoverForUK_2_5_N
        <Description("DP-UKK 3/5")> PC_EndCoverForUKK_5
        <Description("KLM-A")> PC_TerminalMarker2
        'KLESMAN
        ...
        'IGNORED
        <Description("IGNORED_TRMS_MARK")> IGNORED_TerminalMarker
